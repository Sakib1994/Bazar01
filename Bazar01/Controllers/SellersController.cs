...
namespace Bazar01.Controllers
{
    public class SellersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Balance")] Seller seller)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Balance")] Seller seller)
        {
            if (id != seller.Id)
            {
                return NotFound();
